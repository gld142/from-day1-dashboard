...
export const SNAPSHOTS: Record<string, Snapshot[]> = {
  "dadju": [dadju_2026_09_15, dadju_2026_09_16] as Snapshot[],
  "kiko": [kiko_2026_09_15, kiko_2026_09_16] as Snapshot[],
  "nono-la-grinta": [nono_la_grinta_2026_09_15, nono_la_grinta_2026_09_16] as Snapshot[],
};

export const LATEST_DATE = "2026-09-16";
